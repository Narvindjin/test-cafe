...
import buyBackgroundTopRight from "/src/assets/buy-top-right-background.svg";
...
export const StyledSection = styled(Section)`
  ...
  &::after {
    ...
    height: 409px;
    content: "";
    background-image: url(${buyBackgroundTopRight});
    background-size: contain;
    background-repeat: no-repeat;
  }
`;
...
export const StyledListForTime = styled(Ul)`
  display: grid;
  gap: 12px;
...
export const RadioLabelForType = styled.span`
  ...
  &::before {
    ...
    height: 17px;
    width: 17px;
    border: 1px solid ${(props) => props.theme.colorButtonOrange};
    border-radius: 50%;
  }
